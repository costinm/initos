...
- [] add a 3rd EFI option: plain kernel with cmdline/initrd built-in and not accepting further modifications or input, no more efi bootloader.

- [] script to convert docker images to signed initos-erofs to boot

- [] add ssh-mesh and mesh-init
